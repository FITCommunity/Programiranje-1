/*
  ...
  i iz nje uklanja svaku rijeè koja poèinje velikim slovom. Pored toga, funkcija 
  treba da prebroji ukupan broj rijeèi u reèenici prije izmjene. Koristiti sljedeæi 
  prototip funkcije: int ukloniRijeci(char []).
