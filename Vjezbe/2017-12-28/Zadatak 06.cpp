/*
  Napišite  program  u  kojem  ćete  omogućiti  unos  šesteroznamenkastog 
  prirodnog broja i kreiranje niza od 6 cjelobrojnih elemenata. 
  • definirati  i  upotrijebiti  funkciju  void  inicijaliziraj(int[],  int,  int);  koja  će 
  ...
  • definirati i upotrijebiti funkciju float aritmeticka(int [], int); koja će izračunati 
    aritmetičku sredinu (prosječnu vrijednost) elemenata niza;
  • definirati  i  upotrijebiti  funkciju  int  pronaci(int  [],  int,   float)  koja  treba 
    pronaći  i  vratiti  element  niza  koji  je  po  svojoj  vrijednosti  najbliži  prethodno 
    izračunatoj aritmetičkoj sredini;
    
  Ispis  aritmetičke  sredine  i  elementa  koji  je  po  svojoj  vrijednosti  najbliži  aritmetičkoj 
  sredini vršiti u funkciji main.
*/
