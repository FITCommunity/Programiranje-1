/*
  Uz pomoæ matrice realnih brojeva dimenzija 5x7 izraditi program za evidenciju i kalkulaciju uspješnosti vremenskih prognoza (prosjeènih dnevnih temperatura) odreðenog grada. Redovi matrice predstavljaju meteorologe èije se prognoze unose, dok se kolone odnose na vremenski period od 7 dana. Uz matricu je neophodno krerati globalni jednodimenzionalni niz od 7 elemenata koji æe èuvati stvarna mjerenja temperatura za isti vremenski period, a na osnovu kojeg æe se procijeniti uspješnost prognoza pojedinih meteorologa. Vrijednosti elemenata ovog niza prilikom deklaracije postaviti na: 25.5, 26.8, 21, 32, 35.6, 36, 33.5.
Implementaciju programa uraditi pomoæu sljedeæih funkcija:
•	UnesiPrognoze – funkcija za unos prognoza odreðenog meteorologa za kompletan period od 7 dana. Vrijednosti prosjeènih temperatura moraju biti unutar intervala [-20, 50] °C. (Pojasnjenje: unose se podaci za samo jedan izabrani red. Tako ce se korisniku omoguciti da unese prognoze za jednog po jednog meteorologa.)
...
•	PronadjiNajuspjesnijegMeteorologa – funkciju koja pronalazi meteorologa sa najtaènijim vremenskim prognozama, odnosno najveæim procentom uspjeha. (Pojasnjenje: Red koji ima najveci procenat koji se dobije iz prethodno opisane funkcije IzracunajUspjesnost je u stvari red sa najuspjesnijim meteorologom.)  
